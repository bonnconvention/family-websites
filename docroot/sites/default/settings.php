 ...
 * for you.
 */
# Do not set for websites using domain access!
#$base_url = 'http://cms.local.ro';  // NO trailing slash!
...
include DRUPAL_ROOT . '/profiles/cms_build/modules/contrib/domain/settings.inc';
