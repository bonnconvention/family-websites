        ...
        attach: function (context, settings) {
            $.each(settings.datatables, function (selector) {
                $(selector, context).once('datatables', function() {
                    ...
                    if(typeof(settings.fnServerParams) != 'undefined') {
                        settings.fnServerParams = eval('(' + settings.fnServerParams + ')'); // See cms_contacts_library
                    }
                    if(typeof(settings.fnDrawCallback) != 'undefined') {
                        settings.fnDrawCallback = eval('(' + settings.fnDrawCallback + ')'); // See cms_contacts_library
                    }
