  ...
  <tbody>
    ...
    <tr style="font-size: 11px; color: #555555; font-family: Arial, sans-serif;">
      <td style="width: 470px; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; padding-right: 20px; line-height: 1.4;">
        <p><?php echo t("This newsletter is published by the UNEP/AEWA Secretariat &copy; @yyyy", array('@yyyy' => date("Y"))); ?><br /><?php echo t('UNEP/AEWA Secretariat, Platz der Vereinten Nationen 1, 53113 Bonn, Germany'); ?><br /><?php echo t('Tel. (+49 228) 815 2413, Fax. (+49 228) 815 2450, E-mail: <a href="mailto:aewa.secretariat@unep-aewa.org">aewa.secretariat@unep-aewa.org</a>'); ?><br /><a href="<?php echo t('http://www.unep-aewa.org/'); ?>" style="color: #0066c0;"><?php echo t('www.unep-aewa.org'); ?></a></p>
      </td>
